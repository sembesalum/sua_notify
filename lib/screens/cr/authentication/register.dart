...
class CrRegisterScreen extends StatefulWidget {
  const CrRegisterScreen({super.key});

  @override
  State<CrRegisterScreen> createState() => _CrRegisterScreenState();
}

class _CrRegisterScreenState extends State<CrRegisterScreen> {
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: "Full Name",
                        prefixIcon:
                            Icon(Icons.person, color: const Color.fromARGB(255, 41, 97, 18),),
                    ...
                    MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const CrRegisterScreen(), // Replace with actual screen
                          ),
                        );
                      },
                      child: const Padding(
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const CrLoginScreen()),
                      );
                    },
                  ),
                ],
